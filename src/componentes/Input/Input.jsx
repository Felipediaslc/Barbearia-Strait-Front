export const Input = (props) => {
    return (
        <div className="relative mt-2  ">
            <input {  ...props}
            className="sm:tracking-widest w-full sm:w-60  px-5 py-3 text-sm placeholder-transparent bg-transparent  border-0 border-b-2 
             appearance-none 
            ...
            <label htmlFor={props?.id}
              className=" sm:tracking-widest absolute left-2 -top-2.5 px-1 text-sm  text-amber-500 transition-all bg-transparent rounded 
