...
function QuemSomos() {
  return (
      ...
      <section className=' sm:w-[100vw] sm:h-[100vh] w-screen h-screen	 z-0 flex 
      justify-center  bg-quem-pattern   bg-no-repeat bg-cover items-center' id='quem-somos'>
        <div className="sm:w-[100vw] sm:h-[100vh] w-screen h-screen flex-col	backdrop-brightness-[0.4] z-10 flex justify-center items-center bg-none">
